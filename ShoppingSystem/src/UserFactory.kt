...
object AuthenticationHelper {
    ...
    fun adminAuthentication(userId:String, password:String):Admin{
        return AuthenticationData.adminAuthentication(userId.toInt(), password) ?: throw AuthenticationException("Invalid Credentials")
    }
    ...
    fun createUser(role : Role ,userDetails:List<String>,address:List<String> = listOf() ,pinCode: Int = 0){
        when(role){
            ...
            Role.SELLER -> {
                ...
                val seller =Seller(sellerId, userDetails.component1(),userDetails.component2(),LocalDate.parse(userDetails.component3()),userDetails.component4())
            ...
            Role.DELIVERY_AGENT -> {
                ...
                val deliveryAgent = DeliveryAgent(deliveryAgentId,userDetails.component1(),userDetails.component2(),LocalDate.parse(userDetails.component3()),userDetails.component4(), pinCode  )
            ...
            Role.CUSTOMER -> {
                ...
                val customer =Customer(customerId,userDetails.component1(),userDetails.component2(),LocalDate.parse(userDetails.component3()),userDetails.component4(),
